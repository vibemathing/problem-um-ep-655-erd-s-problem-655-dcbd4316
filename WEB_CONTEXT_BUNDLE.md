...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-655-erd-s-problem-655-dcbd4316-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-655"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-655-erd-s-problem-655-dcbd4316-v1",
      "problem_contract_sha256": "177ff2b8899028f71da4e0dd33e7ee1825d73efc3fc36246db17d24aeef5f44c",
      "problem_id": "problem:um-ep-655-erd-s-problem-655-dcbd4316",
      "route_id": "route:um-ep-655-erd-s-problem-655-dcbd4316-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-655-erd-s-problem-655-dcbd4316-source-fidelity-01",
      "graph_id": "graph:um-ep-655-erd-s-problem-655-dcbd4316-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-655-erd-s-problem-655-dcbd4316-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-655-erd-s-problem-655-dcbd4316-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $x_1,\\ldots,x_n\\in \\mathbb{R}^2$ be such that no circle whose centre is one of the $x_i$ contains three other points. Are there at least $ (1+c)\\frac{n}{2} $ distinct distances determined between the $x_i$, for some constant $c>0$ and all $n$ sufficiently large?"
          },
          "statement_sha256": "77b9a661a7da26ff557a0f766de400e783f11808496732d664c8b3f25adb2335"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-655-erd-s-problem-655-dcbd4316-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-655-erd-s-problem-655-dcbd4316-root",
      "route_id": "route:um-ep-655-erd-s-problem-655-dcbd4316-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-655-42a3e14f4817",
        "url": "https://www.unsolvedmath.com/problems/EP-655"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
